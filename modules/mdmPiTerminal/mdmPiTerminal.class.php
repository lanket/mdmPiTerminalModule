...
*/
 ...
 mpt: VERSION int(1) NOT NULL DEFAULT 2
 mpt: MIC_INDEX TINYINT NOT NULL DEFAULT -1
 mpt: OPTIMISTIC_NONBLOCK_TTS BOOLEAN NOT NULL DEFAULT TRUE
 mpt: ASK_ME_AGAIN TINYINT NOT NULL DEFAULT 0
 mpt: QUIET BOOLEAN NOT NULL DEFAULT FALSE
 mpt: NO_HELLO BOOLEAN NOT NULL DEFAULT FALSE
 mpt: BLOCKING_LISTENER BOOLEAN NOT NULL DEFAULT TRUE
 mpt: ENERGY_THRESHOLD TINYINT NOT NULL DEFAULT 0
 mpt: PHRASE_TIME_LIMIT TINYINT NOT NULL DEFAULT 15
 mpt: CHROME_MODE BOOLEAN NOT NULL DEFAULT TRUE
 mpt: CHROME_CHOKE BOOLEAN NOT NULL DEFAULT FALSE
 mpt: CHROME_ALARMSTT BOOLEAN NOT NULL DEFAULT FALSE
 mpt: LANG varchar(10) NOT NULL DEFAULT 'ru'
 mpt: LANG_CHECK BOOLEAN NOT NULL DEFAULT FALSE
 mpt: CLEAR_MODELS BOOLEAN NOT NULL DEFAULT FALSE
 mpt: TOKEN varchar(100) NOT NULL DEFAULT 'd4977cf8ff6ede6efb8d2277c1608c7dbebf18a7'
EOD;
