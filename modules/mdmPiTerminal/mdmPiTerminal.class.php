...
*/
 ...
 mpt: SETTINGS_CHROME_ALARMSTT BOOLEAN NOT NULL DEFAULT 0
  mpt: SETTINGS_LAZY_RECORD BOOLEAN NOT NULL DEFAULT 0
  mpt: SETTINGS_ALARM_RECOGNIZED BOOLEAN NOT NULL DEFAULT 0
  mpt: SETTINGS_BLOCKING_LISTENER BOOLEAN NOT NULL DEFAULT 0
  mpt: SETTINGS_NO_BACKGROUND_PLAY BOOLEAN NOT NULL DEFAULT 0
  mpt: SETTINGS_OPTIMISTIC_NONBLOCK_TTS BOOLEAN NOT NULL DEFAULT 0
  mpt: SETTINGS_AUDIO_GAIN TINYINT NOT NULL DEFAULT 1
 ...
 mpt: YANDEX_SPEAKER varchar(15) NOT NULL DEFAULT 'alyss'
  mpt: YANDEX_GRPC BOOLEAN NOT NULL DEFAULT 0
...
//        $setParam = !$_POST[$param];
      ...
      mpt: SETTINGS_NO_BACKGROUND_PLAY BOOLEAN NOT NULL DEFAULT 0
      mpt: SETTINGS_OPTIMISTIC_NONBLOCK_TTS BOOLEAN NOT NULL DEFAULT 0
      mpt: SETTINGS_AUDIO_GAIN TINYINT NOT NULL DEFAULT 15
        mpt: SNOWBOY_TOKEN varchar(100) NOT NULL DEFAULT 'd4977cf8ff6ede6efb8d2277c1608c7dbebf18a7'
        mpt: SETTINGS_SENSITIVITY varchar(3) NOT NULL DEFAULT '0.7'
        mpt: SETTINGS_PROVIDERTTS varchar(20) NOT NULL DEFAULT 'google'
        mpt: SETTINGS_PROVIDERSTT varchar(20) NOT NULL DEFAULT 'google'
